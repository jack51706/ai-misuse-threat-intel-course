...
這條演化線與本課程 `../shared/02-claude-safeguards-and-bypass-paths.html` 的五條規避路徑完全對應。**GTIG 2025-01 的價值在於它給了這條線一個乾淨的起點：當時最強的攻擊手法，是從 GitHub 複製貼上。**
...
3. 延伸：對照本課程 `../shared/02-claude-safeguards-and-bypass-paths.html` 的五條規避路徑，把這五種組件歸位。
