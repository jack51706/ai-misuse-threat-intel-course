...
**本案疑似用到的手法族**
- **F1 人設／正當商業框定**：把出口轉運規避框定為一般國際貿易／採購諮詢 — ★☆☆。
- 主要規避其實在**存取層（路徑 A）**與真實世界的空殼公司／轉運，而非提示操作 — ★★☆。

**對地端 LLM 的意義** 「幫我規劃跨國採購與物流」在裸地端模型上就是一般商業諮詢；規避管制的意圖不在單一請求裡，地端模型無從辨識。

**地端防護重點**（對映四層 playbook）
1. **架構層＋治理**：對「涉及受管制品項／受制裁實體的採購諮詢」建立經驗證身分閘與合規比對（制裁清單、出口管制清單）。
2. **會話層**：聚合請求識別「在規劃一條規避管制的轉運路徑」。
3. 重點在**存取與合規治理**，非內容過濾——呼應第五節「把判斷從內容移到身分」。
